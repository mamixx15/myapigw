...
export default {
  name: "Maker - ToFigure",
  description: "Mengubah gambar menjadi figurine",
  category: "Maker",
  methods: ["GET"],
  params: ["url"],
