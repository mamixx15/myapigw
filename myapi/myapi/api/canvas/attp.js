...
export default {
  ...
  async run(req, res) {
    ...
    try {
      ...
      tempDir = path.join("/tmp", "attp_temp_" + crypto.randomBytes(8).toString("hex"));
      ...
      // 🟩 Ganti spawn ffmpeg jadi ffmpegInstaller.path
      ...
      return new Promise((resolve, reject) => {
        ...
        ffmpeg.on("close", async code => {
          ...
          if (code === 0) {
            ...
            res.json({
              results: { url: fileUrl, filename: outputFileName, mimetype: "video/mp4" },
              text,
