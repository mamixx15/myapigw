...
const fontPath = path.join(process.cwd(), "src", "services", "canvas", "font", FONT_FILE); // ✅ pakai __dirname biar relatif
...
// ✅ template juga ubah jadi pakai __dirname
...
export default {
  ...
  async run(req, res) {
    try {
      ...
      // ✅ Ganti penyimpanan ke /tmp biar bisa di Vercel
